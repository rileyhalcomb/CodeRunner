...
const CipherMachinePage: React.FC = () => {
    return (
        <>
            <Head>
                <meta name="Cipher Machine" content="Created by Riley Halcomb and Dylan Davis"/>
            ...
            <main className="flex min-h-screen flex-col items-center justify-between p-24">
                ...
                <p style={{fontFamily: "minecraftmedium", textAlign: "center", paddingLeft: "100px", paddingRight: "100px"}}>
                    The cipher machine is designed to create a basic understanding of how ciphers function. This
                    application was created for expanding our knowledge on ciphers and how they can be used to encrypt
                    and decrypt text.
                </p>

                <div className="mb-32 grid text-center lg:max-w-4xl lg:w-full lg:mb-0 lg:grid-cols-1 lg:text-left">
                    <Link href="https://github.com/rileyhalcomb/CipherMachine" passHref
...
export default CipherMachinePage;